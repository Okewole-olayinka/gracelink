...
<head>
    <meta charset="utf-8">
    <title>GRACELINK ENGINEERING -  Construction Company Website Template Free</title>
            ...
            <div class="col-lg-4 text-center py-3">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-start">
                        ...
                        <span> Aboru Street, Lagos, Nigeria</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 text-center border-start border-end py-3">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-start">
                        ...
                        <span>gracelinksnigeria@gmail.com</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 text-center py-3">
    ...
    <div class="container-fluid sticky-top bg-dark bg-light-radial shadow-sm px-5 pe-lg-0">
        <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
            <a href="index.html" class="navbar-brand">
                <h6 class="m-0 display-4 text-uppercase text-white"><i class="bi bi-building text-primary me-2"></i>GRACELINKS ENGINEERING </h6>
            </a>
    ...
    <div class="container-fluid py-6 px-5">
        <div class="row g-5">
            <div class="col-lg-7">
                ...
                <h4 class="text-uppercase mb-3 text-body">LET US HANDLE YOUR NEXT PROJECT</h4>
                ...
                <div class="row gx-5 py-2">
                    <div class="col-sm-6 mb-2">
                        <p class="fw-bold mb-2"><i class="fa fa-check text-primary me-3"></i>ARCHITECTURE</p>
                        <p class="fw-bold mb-2"><i class="fa fa-check text-primary me-3"></i>DESIGN CONSULTANCY AND TRAINING</p>
                        <p class="fw-bold mb-2"><i class="fa fa-check text-primary me-3"></i>INTERIOR DESIGN</p>
                    </div>
                    <div class="col-sm-6 mb-2">
                        <p class="fw-bold mb-2"><i class="fa fa-check text-primary me-3"></i>ROAD NETWORKS</p>
                        <p class="fw-bold mb-2"><i class="fa fa-check text-primary me-3"></i>RENOVATION AND CONSTRUCTION</p>
                        <p class="fw-bold mb-2"><i class="fa fa-check text-primary me-3"></i>First Working Process</p>
                    </div>
                </div>
                <p class="mb-4">These and many more are what we do at GRACE LINKS ENGINEERING SERVICES.</p>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-12">
                        <div class="bg-light p-4">
                            <h4 class="text-uppercase">Eng Adigun sunday</h4>
